...
#WORKUNIT('name', 'hpccsystems_covid19-test_spray_kafka');
#WORKUNIT('protect', TRUE);

// Define attributes for spray
today := STD.Date.Today();
tempSuperFileName := '~hpccsystems::covid19-test::file::raw::JohnHopkins::V2::temp';
lzip:= '10.0.0.6';
...
step1 := SprayFiles;
// Record execution datae and time
