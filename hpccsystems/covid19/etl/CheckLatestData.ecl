...
world := DATASET('~hpccsystems::covid19-test::file::public::JohnHopkins::world.flat', jh.layout, THOR);  
us := DATASET('~hpccsystems::covid19-test::file::public::JohnHopkins::us.flat', jh.layout, THOR);  
