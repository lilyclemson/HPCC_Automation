#WORKUNIT('name', 'hpccsystems_covid19-test_global_metrics_kafka');
...
OUTPUT(statsE, ,'~hpccsystems::covid19-test::file::public::metrics::daily_global.flat', Thor, OVERWRITE);

metrics := CalcMetrics.WeeklyMetrics(statsData, popData, minActive);

OUTPUT(metrics, ALL, NAMED('MetricsByWeek'));
OUTPUT(metrics, ,'~hpccsystems::covid19-test::file::public::metrics::weekly_global.flat', Thor, OVERWRITE);
